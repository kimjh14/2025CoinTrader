...
python tools/backtest.py `
    ...
    --fee 0.0005 `
    --report artifacts/backtest/bt_classic_180d_h20_0.001.json `
    --log_csv artifacts/backtest/trades_classic_180d_h20_0.001.csv `
    --auto_md `
    --md_out artifacts/backtest/trades_classic_180d_h20_0.001.md
